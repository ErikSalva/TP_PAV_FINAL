...
namespace TP_PAV_v1.Entidades
{
    public partial class PrincipalForm : Form
    {
        ...
        private void listadoDeTurnoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ReporteListadoProvincias ventana = new ReporteListadoProvincias();
            ventana.ShowDialog();
        }

        private void listadoDeBarriosToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ReporteListadoBarrios ventana = new ReporteListadoBarrios();
            ventana.ShowDialog();
        }

        private void camionesPorMarcaToolStripMenuItem_Click(object sender, EventArgs e)
        {
            EstadisticaCamiones ventana = new EstadisticaCamiones();
            ventana.ShowDialog();
        }
    }
